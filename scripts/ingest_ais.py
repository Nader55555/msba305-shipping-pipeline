...
BOUNDING_BOXES = [
    # ── 8 Critical Straits — widened for better AIS coverage ──────────────────
    # Persian Gulf + Strait of Hormuz (wide — AIS receivers sparse in Gulf)
    [[22.0,  50.0], [30.0,  60.0]],   # Strait of Hormuz + Persian Gulf

    # Strait of Malacca (full strait length)
    [[-2.0,  98.0], [ 5.0, 106.0]],   # Strait of Malacca

    # Suez Canal + northern Red Sea approach
    [[27.0,  29.0], [33.0,  37.0]],   # Suez Canal

    # Bab el-Mandeb + southern Red Sea + Gulf of Aden
    [[ 8.0,  40.0], [16.0,  50.0]],   # Bab el-Mandeb + Gulf of Aden

    # Strait of Gibraltar + approaches
    [[34.0,  -8.0], [38.0,  -1.0]],   # Strait of Gibraltar

    # Bosphorus + Sea of Marmara + Black Sea entrance
    [[39.0,  26.0], [43.0,  32.0]],   # Bosphorus Strait

    # Strait of Dover + English Channel
    [[49.5,  -2.0], [52.5,   3.5]],   # Strait of Dover

    # Lombok Strait + Sunda Strait alternative
    [[-9.5, 114.0], [-5.0, 118.5]],   # Lombok Strait

    # ── Top 10 Ports by traffic volume ────────────────────────────────────────
    [[29.5, 120.0], [32.5, 123.0]],   # Shanghai    (rank 1)
    [[ 0.0, 102.5], [ 2.5, 105.0]],   # Singapore   (rank 2)
    [[21.0, 112.5], [24.0, 115.5]],   # Shenzhen    (rank 4)
    [[33.5, 127.5], [36.5, 130.5]],   # Busan       (rank 6)
    [[21.0, 113.0], [23.5, 115.5]],   # Hong Kong   (rank 8)
    [[50.5,   3.0], [53.0,   6.0]],   # Rotterdam   (rank 9)
    [[23.5,  53.5], [26.5,  57.0]],   # Dubai + Abu Dhabi
    [[32.0,-120.0], [35.0,-117.0]],   # Los Angeles + Long Beach
    [[39.0,  -75.5], [41.5, -73.0]],  # New York
    [[37.0,  126.5], [38.5, 128.0]],  # Seoul/Incheon (bonus)
]
...
LOCATION_LABELS = [
    ...
    "Shanghai", "Singapore", "Shenzhen", "Busan",
    "Hong Kong", "Rotterdam", "Dubai",
    "Los Angeles", "New York", "Seoul/Incheon",
]
