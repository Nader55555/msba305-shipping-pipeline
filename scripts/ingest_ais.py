...
# Covers all 8 straits + clusters around top 20 ports
...
BOUNDING_BOXES = [
    ...
    # ── Top 20 Ports (±0.8° bounding box around each) ───────────────────────
    [[30.4, 120.7], [32.1, 122.2]],   # Shanghai
    [[ 0.5, 103.1], [ 2.1, 104.5]],   # Singapore
    [[29.1, 120.7], [30.6, 122.3]],   # Ningbo-Zhoushan
    [[21.7, 113.3], [23.3, 114.9]],   # Shenzhen
    [[22.3, 112.5], [23.9, 114.0]],   # Guangzhou
    [[34.4, 128.3], [35.9, 129.9]],   # Busan
    [[38.5, 116.6], [40.2, 118.2]],   # Tianjin
    [[21.5, 113.4], [23.0, 114.9]],   # Hong Kong
    [[51.1,   3.7], [52.7,   5.3]],   # Rotterdam
    [[24.2,  54.2], [25.7,  55.8]],   # Dubai
    [[ 2.2, 100.6], [ 3.8, 102.2]],   # Port Klang
    [[50.4,   3.6], [52.0,   5.2]],   # Antwerp
    [[23.7, 117.3], [25.3, 118.8]],   # Xiamen
    [[32.9,-119.1], [34.5,-117.6]],   # Los Angeles
    [[52.8,   9.2], [54.3,  10.8]],   # Hamburg
    [[32.9,-119.0], [34.5,-117.5]],   # Long Beach
    [[ 0.6, 102.8], [ 2.2, 104.3]],   # Tanjung Pelepas
    [[21.8, 119.5], [23.4, 121.1]],   # Kaohsiung
    [[38.1, 120.8], [39.7, 122.4]],   # Dalian
    [[39.9,  -75.0], [41.5, -73.4]],  # New York
]
...
LOCATION_LABELS = [
    ...
    "Busan", "Tianjin", "Hong Kong", "Rotterdam", "Dubai", "Port Klang",
    "Antwerp", "Xiamen", "Los Angeles", "Hamburg", "Long Beach",
    "Tanjung Pelepas", "Kaohsiung", "Dalian", "New York",
]
...
if __name__ == "__main__":
    ...
    if not records:
        print("  ✗ No records collected — AISStream may be unavailable")
        print("    Check your AISSTREAM_API_KEY secret and AISStream status")
        raise RuntimeError("No AIS records collected")
