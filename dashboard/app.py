...
with st.sidebar:
    ...
    st.markdown('<div style="font-size:11px;color:#2a4a6a;margin-top:24px;line-height:1.6;">Sources: UN Comtrade · BDI (Stooq, daily) · OpenWeatherMap · AISStream<br>Storage: BigQuery | Dashboard: Streamlit</div>', unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    title("Baltic Dry Index", "Global bulk shipping cost indicator · Stooq · auto-updated daily")
...
<div style="margin-top:3rem;padding:1rem;border-top:1px solid #1e3a5f;
  ...
  Sources: UN Comtrade · BDI (Stooq, daily) · OpenWeatherMap · AISStream &nbsp;·&nbsp;
